            ...
            <div className={cx('list-ticket')}>
              <div className={cx('ticket-item')}>
                ...
                <div className={cx('info-ticket')}>
                  <img src="https://cinema.momocdn.net/img/17498461059164213-poster.jpg" alt="Địa đàng sụp đổ" />
                  <div className={cx('info-film')}>
                    <div className={cx('name')}>Thiện ác đối đầu 3</div>
                    <div className={cx('date')}>
                      <span>Ngày chiếu:</span> <div>11-02-2023</div>
                    </div>
                    <div className={cx('date')}>
                      <span>Phòng chiếu:</span> <div>01</div>
                    </div>
                    <div className={cx('date')}>
                      <span>Số vé:</span> <div>2</div>
                    </div>
                  </div>
                </div>
                <div className={cx('total-amount')}>
                  <div>
                    ...
                    Tổng cộng: <span>399.000 VNĐ</span>
                  </div>
